...
All notable changes to SASdocX are documented in this file.
...
- **General-review wave (multi-agent, 31 confirmed findings).** Engine: the
  ...
  12-slot brand clrScheme from `_saslib` (docx/pptx/xlsx had drifted apart
...
- **Contributor onramp (REFLECTIONS P1).** `CONTRIBUTING.md` expanded from a
  ...
  `scripts/sasdockit/README.md` created as the engine internals map (module
...
- **Engine commands now work from the skill folder (plugin onboarding).** Every
  skill/command doc taught `python scripts/sasdockit/cli.py ...`, which resolves
  ...
  resolves the engine root by itself; `SASDOCX_ROOT` overrides), a root-level
...
- The three `SKILL.md` now say "the six questions" (matching the shared
  `reference/comprehension.md`); `sasdocx/SKILL.md` gains the
...
- **Lazy Office-lib imports in `qa/checks_deterministic.py` and `cli.py`.** The
  ...
  invocation pays only for the active format. `import sasdockit.cli` 191ms ->
...
- **Test suite: injected visual seam + class-scoped fixture extraction.** The 4
  ...
  and the opt-in `SASDOCX_RUN_REAL_RENDER=1` lane.

### Added

- **Example docx template now exercises every new capture axis.** The synthetic
  `examples/templates/sasdocx_template.docx` (rebuilt byte-deterministically from
...
- Schema: a profile whose major version is newer than this build supports
  now fails with a single clear "upgrade sasdocx or re-extract" message
...
- `sasdocx`, `saspptx`, and `sasxlsx` skills for same-format
...
- SASdocX is alpha software. DOCX is the reference vertical; PPTX and XLSX
  share the same engine and are intentionally catching up through the eval
  suite and visual repair workflow.

[0.10.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.10.0
[0.9.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.9.0
[0.8.1]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.8.1
[0.8.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.8.0
[0.7.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.7.0
[0.6.2]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.6.2
[0.6.1]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.6.1
[0.6.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.6.0
[0.5.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.5.0
[0.4.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.4.0
[0.3.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.3.0
[0.2.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.2.0
[0.1.0]: https://github.com/ferdinandobons/sasdocx/releases/tag/v0.1.0
