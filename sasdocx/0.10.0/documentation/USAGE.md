...
[`skills/sasdocx/examples/intermediate-document.example.json`](../skills/sasdocx/examples/intermediate-document.example.json).
...
`python scripts/sasdockit/cli.py doctor` to preflight dependencies.
