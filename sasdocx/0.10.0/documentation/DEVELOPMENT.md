...
SASDOCX_RUN_REAL_RENDER=1 PYTHONPATH=scripts \
...
map in [`scripts/sasdockit/README.md`](../scripts/sasdockit/README.md) before
opening a PR.
...
```bash
python scripts/corpus_benchmark.py --corpus ~/my-sasdocx-corpus [--qa auto]
```
