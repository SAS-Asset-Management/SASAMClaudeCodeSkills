...
:class:`~sasdockit.common.typography.RunFacts` view so the format-neutral capture
...
:data:`~sasdockit.common.color.THEME_SLOTS`, never a tuned slot):
  ...
  - **Token namespace:** an openpyxl theme color is an INTEGER index into the
    ...
    :data:`~sasdockit.common.color.THEME_SLOTS` lookup, which would mislabel a default
...
from sasdockit.common.color import THEME_SLOTS
