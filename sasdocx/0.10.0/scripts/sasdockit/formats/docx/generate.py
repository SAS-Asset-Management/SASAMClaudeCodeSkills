...
from sasdockit.common import appearance
from sasdockit.common import color as colorutil
from sasdockit.common import text as textutil
from sasdockit.common.links import is_safe_link_url
from sasdockit.formats.docx import cover, structure
from sasdockit.formats.docx.styles import lookup_style
from sasdockit.ir import components
from sasdockit.ir import model as ir
from sasdockit.ooxml import chart as chartlib
from sasdockit.ooxml.idempotency import repack_fixed_timestamps
from sasdockit.profile import schema, store
from sasdockit.profile.reconcile import confidence_clears_floor
from sasdockit.profile.resolver import ProfileResolver
from sasdockit.qa.checks_deterministic import (
    check_index_matches_content,
    check_no_net_structure_loss,
)
from sasdockit.qa.model import Finding
...
def generate(
    ...
    *,
    ...
    :func:`sasdockit.formats.docx.styles.lookup_style`, and a role that resolves to
