...
from sasdockit.ooxml.fields import iter_complex_field_events
from sasdockit.ooxml.names import local_name as _local_name, make_qn
...
# ``_local_name`` come from the shared :mod:`sasdockit.ooxml.names` layer; they are
