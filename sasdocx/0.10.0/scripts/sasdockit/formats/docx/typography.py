...
:data:`~sasdockit.common.typography.MIN_RUNS` explicit values and a winner covering
at least :data:`~sasdockit.common.typography.MIN_DOMINANCE` of them), with its
...
from sasdockit.common.typography import (
    PALETTE_WHERE,
)
from sasdockit.common.typography import (
...
from sasdockit.ooxml import names
...
class _DocxRunFact:
    """A docx run, reduced to the structural :class:`~sasdockit.common.typography.RunFacts`
...
def capture_fonts(doc, roles: dict, theme: dict, *, facts=None) -> None:
    ...
    :func:`~sasdockit.common.typography.capture_appearance`; the default
...
def capture_palette(doc, roles: dict, theme: dict) -> None:
    ...
    :func:`~sasdockit.common.typography.capture_palette_facts`. The bucket namespace is
...
class _DocxParaGeometryFact:
    ...
    :class:`~sasdockit.common.typography.ParaGeometryFacts` view the shared geometry
...
def capture_geometry(doc, roles: dict, theme: dict) -> None:
    ...
    :func:`~sasdockit.common.typography.capture_paragraph_geometry`; the default
...
def _fold_table_appearance(facts: list) -> dict:
    ...
    :func:`~sasdockit.common.typography.dominant` floor. Returns ``{}`` when nothing
