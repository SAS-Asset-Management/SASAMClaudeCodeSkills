...
pure-Python sibling :mod:`sasdockit.common.color` for :data:`THEME_SLOTS`), so every
extractor can import it cheaply, exactly like :mod:`sasdockit.common.text`.
...
from sasdockit.ooxml import names as ooxml_names
from sasdockit.ooxml import pack as ooxml_pack
