...
from sasdockit.ooxml import names, pack
from sasdockit.profile import comprehension as comprehensionmod
...
# truth in sasdockit.common.color (shared with the resolver's hex enrichment). A token
...
def check_overrides_applied(profile: dict) -> list[Finding]:
    ...
    # late ``from sasdockit.qa import checks_deterministic`` imports elsewhere).
