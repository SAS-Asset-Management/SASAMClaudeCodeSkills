...
def _real_render_requested() -> bool:
    return (
        os.environ.get("SASDOCX_RUN_REAL_RENDER") == "1" and vqa.renderers_available()
    )


@unittest.skipUnless(
    _real_render_requested(),
    "set SASDOCX_RUN_REAL_RENDER=1 to run real soffice/pdftoppm render tests",
)
