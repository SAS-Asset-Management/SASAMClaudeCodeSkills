...
from sasdockit.formats.docx import typography
from sasdockit.ir import model as ir
from sasdockit.common import appearance as common_appearance
from sasdockit.profile import schema
from sasdockit.profile.resolver import ProfileResolver
from sasdockit.qa import checks_deterministic
...
class ApplyRunColorTokenTest(unittest.TestCase):
    ...
    def test_minted_palette_alias_resolves_and_applies(self):
        ...
        from sasdockit.profile import comprehension as comp_mod
...
class ApplyGeometryTest(unittest.TestCase):
    ...
    def test_geometry_not_written_when_set(self):
        ...
        from sasdockit.formats.docx import generate as gen
