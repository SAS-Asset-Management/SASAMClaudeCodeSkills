...
from sasdockit.profile import compare  # noqa: E402
...
def _profile(
    *,
    ...
    return {
        "$schema": "https://sasdocx/schema/profile-1.json",
...
class CompareCliTest(unittest.TestCase):
    ...
    def test_cli_compare_is_read_only_and_deterministic(self):
        ...
        docx_t = ROOT / "examples" / "templates" / "sasdocx_template.docx"
        pptx_t = ROOT / "examples" / "templates" / "sasdocx_template.pptx"
