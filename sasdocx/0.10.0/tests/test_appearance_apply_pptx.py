...
from sasdockit.formats.pptx import generate as pg  # noqa: E402
from sasdockit.ir.model import parse_idoc  # noqa: E402
from sasdockit.profile import schema  # noqa: E402
...
class PptxBackendSetOnlyWhenUnsetTest(unittest.TestCase):
    ...
    def test_explicit_font_size_color_are_not_clobbered(self) -> None:
        ...
        from sasdockit.profile.resolver import ResolvedOp
