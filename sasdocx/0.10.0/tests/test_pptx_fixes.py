...
from sasdockit.formats.pptx import extract as px
from sasdockit.formats.pptx import generate as pg
from sasdockit.formats.pptx import structure as ps
from sasdockit.ir import components as ir_components
from sasdockit.ir import model as ir
from sasdockit.ir.model import parse_idoc
from sasdockit.profile import schema, store
from sasdockit.qa import checks_deterministic as cd
...
class MI7CliFindingsWiringTest(unittest.TestCase):
    ...
    def _run_cli_reconcile(self, tmp: Path, *, demo_slide_ref: str):
        ...
        from sasdockit.cli import main
...
class PalettePptxParityTest(unittest.TestCase):
    ...
    def test_pptx_extract_seeds_palette_and_surfaces_inventory(self):
        ...
        from sasdockit.profile import comprehension as comp
