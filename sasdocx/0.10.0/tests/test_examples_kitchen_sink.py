...
Extracts each examples/templates/sasdocx_template.{docx,pptx,xlsx}, generates from
...
The templates are 100% synthetic SASdocX showcases; no proprietary file is used.
"""
...
from sasdockit.grid.model import GridDocument
from sasdockit.ir.model import parse_idoc
from sasdockit.profile import store
...
class _Base(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.template = TEMPLATES / f"sasdocx_template.{cls.KIND}"
...
class PptxKitchenSink(_Base):
    ...
    def test_reconcile_path_no_duplicate_parts(self):
        ...
        from sasdockit.formats.pptx import structure as ps
