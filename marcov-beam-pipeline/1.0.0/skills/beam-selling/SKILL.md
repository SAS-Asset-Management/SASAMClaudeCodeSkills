...
This skill accepts a **company name** or **deal name** as its primary input. It builds on the output from the `MBP:b2b-research` skill, but can also start from scratch.

### Invocation Examples

```
/MBP:beam-selling Acme Corp
/MBP:beam-selling Resume Acme Corp engagement
/MBP:beam-selling Advance BHP to Stage 3
/MBP:beam-selling Review gate criteria for GeelongPort
/MBP:beam-selling Show all active engagements
```

### Integration with MBP:b2b-research

If a MBP:b2b-research dossier exists for the target company, **automatically ingest it** as the foundation for Stage 1 (Qualify). Look for:
...
**Activities**:
- Review MBP:b2b-research dossier (if available)
...
- ICP alignment score (from MBP:b2b-research or assessed here)
...
To resume next time, run: /MBP:beam-selling [Company Name]
```
...
4. Check for MBP:b2b-research output (HTML report or Markdown dossier)
5. If found: ingest the research as the Stage 1 foundation
6. If not found: offer to run MBP:b2b-research first, or proceed with manual input
