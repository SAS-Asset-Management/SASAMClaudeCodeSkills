...
```
/MBP:linkedin-post Write a post about AI readiness for asset managers
/MBP:linkedin-post Promote this article: [paste article or link]
/MBP:linkedin-post Quick insight on why most risk registers are useless
/MBP:linkedin-post Carousel text: 5 signs your data isn't AI-ready
/MBP:linkedin-post Myth-busting post about predictive maintenance
```
...
After the post is finalised, offer to generate a matching image using the MBP:nano-banana skill:
...
3. **Call MBP:nano-banana** with 1:1 aspect ratio (optimal for LinkedIn)
...
This skill integrates with **MBP:nano-banana** to generate matching visuals for LinkedIn posts.
...
The MBP:nano-banana skill will automatically enhance with hyper-realistic modifiers.
...
### Calling MBP:nano-banana

Use the Skill tool to invoke MBP:nano-banana with the generated prompt:

```
/MBP:nano-banana "[generated prompt based on post content]"
```

The MBP:nano-banana skill will:
...
| `image` | Generate a matching image for the current post using MBP:nano-banana (1:1 aspect ratio) |
